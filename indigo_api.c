...
struct indigo_api indigo_api_list[] = {
    ...
    { API_INDIGO_STOP_LOOP_BACK_DATA, "INDIGO_STOP_LOOP_BACK_DATA", NULL, NULL },
};
...
struct indigo_tlv indigo_tlv_list[] = {
    ...
    { TLV_SCAN_ENTRY_FLUSH, "SCAN_ENTRY_FLUSH" },
    { TLV_OWE_TRANSITION_SSID, "OWE_TRANSITION_SSID" },
    { TLV_OWE_TRANSITION_IFNAME, "OWE_TRANSITION_IFNAME" },
    { TLV_BEACON_HEXDUMP_REQUIRED, "BEACON_HEXDUMP_REQUIRED" },
    { TLV_SERVER_CERT, "SERVER_CERT" },
    { TLV_TEST_PLATFORM_IP, "TEST_PLATFORM_IP" },
    { TLV_TEST_PLATFORM_PORT, "TEST_PLATFORM_PORT" },
    ...
    { TLV_HE_FILS_DISCOVERY_TX, "ILS_DISCOERY_TX" },
};
